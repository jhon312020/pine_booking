                ...
                <div class="col-lg-6">
                        <div class="flash-message">
                          @foreach (['danger', 'warning', 'success', 'info'] as $msg)
                            ...
                            <p class="alert alert-{{ $msg }}">Room {{ Session::get('added_room') }} updated successfully</p>
                            @endif
                          @endforeach
                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST" action="{{ url('room/edit/'.$room->id) }}">
                                {!! csrf_field() !!}
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Room Number" name="room_number" value="{{ $room->room_number }}">
                                </div>
