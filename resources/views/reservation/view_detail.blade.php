                            ...
                            <form role="form" method="POST" action="{{ url('reservation/edit/'.$reservation->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                         ...
                                         <label >{{ date('d-m-Y', strtotime($reservation->checkin)) }}</label>
                                    </div>
                                    <div class="form-group">
                                         <label >Check out date : </label>
                                         <label >{{ date('d-m-Y', strtotime($reservation->checkout)) }}</label>
                                    </div>
                                    <div class="form-group">
                                         <label>No of rooms booked : </label>
                                         <label >{{ $reservation->booked_rooms }} </label>
                                    </div>
                                    <div class="form-group">
                                         <label >Rent per day : </label>
                                         <label >{{ $reservation->rent }}</label>
                                    </div>
